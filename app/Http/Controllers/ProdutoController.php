...
class ProdutoController extends Controller
{
    ...
    public function create(Request $request)
    {
        ...
        // Buscar todos os setores ativos do banco de dados
        $setores = \App\Models\Setor::where('ativo', true)
            ->orderBy('nome')
            ->get();

        return view('produtos.create', compact('source', 'setores'));
    }
    ...
    public function store(Request $request)
    {
        $request->validate([
            ...
            'setor_id' => 'nullable|exists:setores,id',  // Validar o ID do setor
        ...
        if (in_array($idProduct, $ids) && $idProduct != null) {
            ...
            Produto::create([
                ...
                'marca' => $request->marca,
                'setor_id' => $request->setor_id,  // Usar o ID do setor
